...
public interface TxService {
    ...
    boolean crossTransactionCommit(Chain chain, Transaction transaction, BlockHeader blockHeader) throws NulsException;

    boolean crossTransactionRollback(Chain chain, Transaction transaction, BlockHeader blockHeader) throws NulsException;
