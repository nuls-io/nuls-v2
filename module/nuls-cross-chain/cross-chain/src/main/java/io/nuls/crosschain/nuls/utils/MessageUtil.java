...
public class MessageUtil {
     ...
     * 对新收到的交易进行处理
     * */
    public static void handleNewHash(Chain chain, NulsDigestData hash,int chainId,String nodeId){
        int tryCount = 0;
     ...
     * 交易签名拜占庭处理
     * */
    public static void signByzantine(Chain chain, int chainId, NulsDigestData realHash, Transaction ctx, BroadCtxSignMessage messageBody,String nativeHex,String signHex)throws NulsException, IOException {
     ...
     * @return                 处理是否成功
     * */
    public static boolean handleNewCtx(Transaction ctx, NulsDigestData originalHash, NulsDigestData nativeHash, Chain chain, int fromChainId,String nativeHex,String originalHex,boolean isLocalCtx){
    ...
    public static void regainCtx(Chain chain,int chainId,NulsDigestData cacheHash,NulsDigestData nativeHash,NulsDigestData originalHash,String originalHex,String nativeHex){
     ...
     * 统计交易验证结果
     * */
    private static boolean verifyResult(Chain chain,int fromChainId,NulsDigestData requestHash){
        try {
     ...
     * @param chain
     * */
    private static boolean saveNewCtx(Transaction ctx, Chain chain , NulsDigestData originalHash,String nativeHex,String originalHex){
        int handleChainId = chain.getChainId();
        /*
    ...
    private static boolean signCtx(Chain chain, Transaction ctx,NulsDigestData originalHash, NulsDigestData nativeHash,String nativeHex,String originalHex,TransactionSignature transactionSignature)throws NulsException,IOException{
        /*
     ...
     * 广播签名
     * */
    private static void broadcastCtx(Chain chain,NulsDigestData hash,int chainId,String originalHex,String nativeHex){
