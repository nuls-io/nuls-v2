...
public class EconomicManager {
     ...
     */
    public static List<CoinTo> getRewardCoin(AgentInfo agentInfo, RoundInfo roundInfo, ConsensusConfigInfo consensusConfig, long unlockHeight, Map<String, BigInteger> awardAssetMap, long nowHeight) throws NulsException {
        ...
        */
        if (BigIntegerUtils.isEqual(agentInfo.getDeposit(), BigInteger.ZERO) || nowHeight >= 19300000) {
