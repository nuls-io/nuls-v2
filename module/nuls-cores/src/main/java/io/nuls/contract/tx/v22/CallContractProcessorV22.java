package io.nuls.contract.tx.v22;
...
@Component("CallContractProcessorV22")
public class CallContractProcessorV22 implements TransactionProcessor {
    ...
    public Map<String, Object> validate(int chainId, List<Transaction> txs, Map<Integer, List<Transaction>> txMap, BlockHeader blockHeader) {
        ...
        for(Transaction tx : txs) {
            ...
            callTx.copyTx(tx);
            try {
                Result validate = callContractTxValidator.validateV22(chainId, callTx);
