...
@Component("CallContractProcessorV20")
public class CallContractProcessorV20 implements TransactionProcessor {
    ...
    public Map<String, Object> validate(int chainId, List<Transaction> txs, Map<Integer, List<Transaction>> txMap, BlockHeader blockHeader) {
        ...
        for(Transaction tx : txs) {
            ...
            callTx.copyTx(tx);
            try {
                Result validate = callContractTxValidator.validateV20(chainId, callTx);
