...
@Component("CallContractProcessorV14")
        ...
        try {
            ...
            if (batchInfo != null) {
                ...
                for (Transaction tx : txs) {
                    ...
                    callContractTxProcessor.onCommitV14(chainId, wrapperTx);
                }
            }
    ...
    public boolean rollback(int chainId, List<Transaction> txs, BlockHeader blockHeader) {
        try {
            ...
            for (Transaction tx : txs) {
                ...
                callContractTxProcessor.onRollbackV14(chainId, new ContractWrapperTransaction(tx, call));
            }
            return true;
        } catch (NulsException e) {
            Log.error(e);
