package io.nuls.ledger.service.v15;
...
@Component("AssetRegTransferProcessorV15")
    ...
    public Map<String, Object> validate(int chainId, List<Transaction> txs, Map<Integer, List<Transaction>> txMap, BlockHeader blockHeader) {
        ...
        try {
            ...
            for (Transaction tx : txs) {
                ...
                ErrorCode errorCode = assetRegMngService.batchAssetRegValidatorV15(txLedgerAsset, toAddress, destroyAsset, chainId);
                if (null == errorCode) {
