...
/**
 * Receive and process transactions sent by other nodes in the networkhashTo request information on the complete transaction
 */
...
public class GetTxMessageHandler implements MessageProcessor {
    ...
    public void process(int chainId, String nodeId, String msgStr) {
        Chain chain = null;
        try {
            //Analyze and obtain complete transaction messages
