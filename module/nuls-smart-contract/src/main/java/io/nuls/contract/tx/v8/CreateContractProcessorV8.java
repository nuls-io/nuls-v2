...
@Component("CreateContractProcessorV8")
public class CreateContractProcessorV8 implements TransactionProcessor {
        ...
        try {
            ...
            if (batchInfo != null) {
                ...
                for (Transaction tx : txs) {
                    ...
                    createContractTxProcessor.onCommitV8(chainId, wrapperTx);
                }
            }
    ...
    public boolean rollback(int chainId, List<Transaction> txs, BlockHeader blockHeader) {
        try {
            ...
            for (Transaction tx : txs) {
                ...
                createContractTxProcessor.onRollbackV8(chainId, new ContractWrapperTransaction(tx, create));
            }
            return true;
        } catch (Exception e) {
            Log.error(e);
