...
### 1.10 Verify if the address is correct
#### Cmd: validateAddress
...
### 1.11 Generate account address based on account public key
...
### 1.22 Query the list of accounts created in the wallet
#### Cmd: getAddressList
_**Detailed description: Query the list of accounts created in the wallet**_
...
### 1.23 Clear text private key digest signature message
#### Cmd: signMessage
_**Detailed description: Clear text private key digest signature message**_

#### parameter list
| Parameter Name        |  Parameter type  | Parameter Description | Is it mandatory to fill in |
| ---------- |:------:| ---- |:----:|
| message    | string | news   |  yes   |
| privateKey | string | Private key   |  yes   |

#### Return value
| Field Name | Field type | Parameter Description |
| --- |:----:| ---- |
| N/A | void | Message signature |
#### Example request data: 
nothing
...
### 1.24 Verify message signature
#### Cmd: verifySignedMessage
_**Detailed description: Verify message signature**_

#### parameter list
| Parameter Name       |  Parameter type  | Parameter Description | Is it mandatory to fill in |
| --------- |:------:| ---- |:----:|
| message   | string | news   |  yes   |
| signature | string | Message signature |  yes   |
| publicKey | string | Public key   |  yes   |

#### Return value
| Field Name |  Field type   | Parameter Description   |
| --- |:-------:| ------ |
|     | boolean | Verify if successful |
#### Example request data: 
nothing
...
### 1.25 Obtain public key based on private key
#### Cmd: getPubKeyByPriKey
_**Detailed description: Obtain public key based on private key**_
...
| Field Name | Field type | Parameter Description        |
| --- |:----:| ----------- |
| N/A | void | Public keyHEXEncoding string |
#### Example request data: 
nothing
...
### 1.27 Query locked account information
...
### 2.1 Obtain network status information for this node
#### Cmd: getNetworkInfo
_**Detailed description: Obtain network status information for this node**_
...
| Field Name |    Field type     | Parameter Description   |
| --- |:-----------:| ------ |
| Return value | networkinfo | Return to network status |
#### Example request data: 
nothing
...
### 2.2 Query block headers based on block height
...
### 2.3 Based on blockshashQuery block header
#### Cmd: getHeaderByHash
...
### 2.4 Query the latest block header information
...
### 2.6 Query blocks based on block height
...
### 2.7 Based on blockshashQuery Block
#### Cmd: getBlockByHash
_**Detailed description: This interface contains all transaction information packaged in blocks. It returns a large amount of data and should be called with caution**_
...
### 2.8 Query block serialization strings based on block height
...
### 2.9 Based on blockshashQuery block serialization string
...
### 2.10 Get the latest main chain height
#### Cmd: getLatestHeight
...
_**Detailed description: Initiate transfer transactions for a single account or asset,Transfer assets to other parallel chain assets within the chain**_

#### parameter list
| Parameter Name          |  Parameter type  | Parameter Description   | Is it mandatory to fill in |
| ------------ |:------:| ------ |:----:|
| chainId      |  int   | chainid    |  yes   |
| assetChainId |  int   | Asset Chainid  |  yes   |
| assetId      |  int   | assetid   |  yes   |
...
### 3.7 Single cross chain transfer
#### Cmd: crossTransfer
...
### 3.10 Offline assembly transfer transaction
...
### 3.11 Calculate the transaction fee required for offline creation of transfer transactions
...
### 3.12 Calculate the transaction fee required for offline creation of cross chain transfer transactions
#### Cmd: calcCrossTxFee
...
### 3.13 Offline assembly transfer transaction
...
### 3.14 Calculate the transaction fee required for offline creation of transfer transactions
...
### 6.3 Obtain parallel chain asset information
#### Cmd: getCrossAssetInfo
_**Detailed description: Obtain parallel chain asset information**_

#### parameter list
| Parameter Name     | Parameter type | Parameter Description  | Is it mandatory to fill in |
| ------- |:----:| ----- |:----:|
| chainId | int  | Asset ChainID |  yes   |
| assetId | int  | assetID  |  yes   |

#### Return value
| Field Name |          Field type          | Parameter Description |
| --- |:----------------------:| ---- |
| Return value | crossassetregisterinfo |      |
#### Example request data: 
nothing
